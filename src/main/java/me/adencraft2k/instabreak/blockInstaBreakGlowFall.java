...
public class blockInstaBreakGlowFall extends Block {
	//Note: Most of this code is copied from Minecraft's BlockFalling class:
	//		net.minecraft.block.BlockFalling
	public static boolean fallInstantly;
    private static final String __OBFID = "CL_00000240";
    
	public blockInstaBreakGlowFall(Material Material) {
		super(Material);
